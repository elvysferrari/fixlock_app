...
class DispositivoScreen extends StatefulWidget {
  ...
  const DispositivoScreen({required this.dispositivo, Key? key})
      : super(key: key);
...
class _DispositivoScreenState extends State<DispositivoScreen> {
  ...
  Widget build(BuildContext context) {
    var liberarBotoes =
        dispositivoController.connection.value != null ? true : false;
              ...
              children: [
                  GestureDetector(
                    onTap: () async {
                      ...
                      if (dispositivoController.connection.value == null) {
                        await dispositivoController.connect(
                            widget.dispositivo.serial, widget.dispositivo.id);
                      } else {
                        await dispositivoController
                            .disconnect(widget.dispositivo.id);
                      }
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              dispositivoController.connection.value != null
                                  ? "DESCONECTAR"
                                  : "CONECTAR",
                      ...
                      child: GestureDetector(
                        onTap: () async {
                          if (dispositivoController.connection.value != null) {
                            ...
                            await dispositivoController.abrir(
                                widget.dispositivo.serial,
                                widget.dispositivo.id);
                            await Future.delayed(const Duration(seconds: 5));
                          } else {
                            Get.snackbar("Dispositivo desconectado",
                      ...
                      child: GestureDetector(
                        onTap: () async {
                          if (dispositivoController.connection.value != null) {
                            ...
                            dispositivoController.ligarEnergia(
                                widget.dispositivo.serial,
                                widget.dispositivo.id);
                            await Future.delayed(const Duration(seconds: 5));
                          } else {
                  ...
                  Visibility(
                      ...
                      child: GestureDetector(
                        onTap: () {
                          if (dispositivoController.connection.value != null) {
                            Get.to(() => DispositivoConfiguracaoScreen(
                          ...
                          Expanded(
                            child: ElevatedButton(
                              ...
                              onPressed: () async {
                                ...
                                dispositivoController.desligarEnergia(
                                    widget.dispositivo.serial,
                                    widget.dispositivo.id);
